        ...
        <nav className={`custom-navbar ${theme}`}>
            <div className="container-fluid p-2">
                <div className="d-flex flex-row justify-content-between">
                    <Link className={`d-flex flex-column navbar-link ${theme} appName`} to="/">
                        <h3 className={`navbar-link-text ${theme}`}>TaskMaster</h3>
                    </Link>
                    <div className="d-flex flex-row justify-content-end px-3">
                        <button className={`flex-column navbar-button ${theme} py-1 px-2 mx-1`} data-testid="themeToggleBtn" onClick={toggleTheme}>
                            {theme === 'light' ? (
                        ...
                        {/* <Link className={`d-flex flex-column justify-content-center navbar-link ${theme} px-0 mx-1`} to="/">
                            <p className={`navbar-link-text ${theme}`}>
                                About
                            </p>
                        </Link> */}
                        {isLoggedIn ? (
                            <button className={`d-flex flex-column justify-content-center navbar-button ${theme} p-0 mx-1`} type="button" onClick={handleLogout}>
                                <p className={`navbar-link-text ${theme}`}>
                                    Log Out
                                </p>
                            </button>
                            ...
                            <>
                                <Link className={`d-flex flex-column justify-content-center navbar-link ${theme} p-0 mx-1`} to="/login/">
                                    <p className={`navbar-link-text ${theme}`}>
                                        Log In
                                    </p>
                                </Link>
                                <Link className={`d-flex flex-column justify-content-center navbar-link ${theme} p-0 mx-1`} to="/signup/">
                                    <p className={`navbar-link-text ${theme}`}>
                                        Sign Up
                                    </p>
                                </Link>
